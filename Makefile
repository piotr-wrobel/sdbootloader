...
# Ten plik został zmodyfikowany przez mlodedzrwale, wszystkie komentarze dodane przez osoby    #
# które wcześniej teorzyły ten plik są niezmienione na samym końcu pliku.                      #
################################################################################################
...
# >> Ten plik został zmodyfikowany patrz: opcje linkera i kompilatora.
#----------------------------------------------------------------------------
